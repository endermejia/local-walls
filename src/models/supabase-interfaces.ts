// Type aliases derived from Supabase generated types
// Source: ./supabase-generated.ts (auto-generated by Supabase)
// Note: These types are direct aliases to `Tables[TableName].Row/Insert/Update`.
// Do not modify the structures manually; if tables change, re-generate `supabase-generated.ts`.
