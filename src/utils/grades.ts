import type { RoutesByGrade, Route } from '../models';
...
/**
 * Counts routes by grade for a given set of route IDs.
 * - Trims grade strings
 * - Skips empty/undefined grades
 */
export function countRoutesByGrade(
  routeIds: Set<string>,
  routes: readonly Route[],
): RoutesByGrade {
  if (!routeIds || routeIds.size === 0) return {} as RoutesByGrade;
