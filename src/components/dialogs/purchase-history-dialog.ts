        ...
        <div class="flex flex-col gap-1 p-2">
          @if (purchasesResource.isLoading()) {
            ...
            @for (p of purchasesResource.value(); track p.id) {
              <button
                class="flex items-center justify-between p-4 rounded-2xl hover:bg-(--tui-background-neutral-hover) transition-colors text-left w-full border-none bg-transparent cursor-pointer"
