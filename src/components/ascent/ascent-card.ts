...
@Component({
  ...
  template: `
    ...
    <div
      ...
      class="flex flex-col gap-3 p-4 sm:rounded-3xl rounded-none relative no-underline text-inherit hover:no-underline -mx-4 sm:mx-0 w-[calc(100%+2rem)] sm:w-full text-left"
    >
      <header
        tuiHeader
